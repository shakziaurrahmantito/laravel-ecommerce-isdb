...
<style type="text/css">
 ...
 <div class="col-md-10">
  <div class="m-2 my-4">
        ...
        <div class="">
          <h3 class="d-inline-block">Order checking</h3>
          @foreach($customerInfo as $data)
            <a href="{{url('/confirmComplteorder/'.$data->customers_id)}}" onclick="return confirm('Are you sure confirm?')" class="float-right btn btn-primary ml-2">Confirm</a>
          @endforeach
